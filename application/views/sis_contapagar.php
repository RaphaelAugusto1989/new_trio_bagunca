            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Constas a Pagar</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content" >
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <a href="<?= site_url('Financeiro/NovaContaPagar')?>" class="btn btn-success btn-sm pl-3 pr-3"> <i class="fas fa-plus"></i> Conta</a>
                    </div>
                </div>
                <div class="row">
